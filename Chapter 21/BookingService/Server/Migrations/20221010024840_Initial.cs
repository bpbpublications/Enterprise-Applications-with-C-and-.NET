        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortOriginId = table.Column<int>(type: "int", nullable: true),
                    PortDestinyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Booking", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Booking_ContainerType_ContainerTypeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Booking_Port_PortDestinyId",
                        column: x => x.PortDestinyId,
                        principalTable: "Port",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Booking_Port_PortOriginId",
                        column: x => x.PortOriginId,
                        principalTable: "Port",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Booking_ContainerTypeId",
                table: "Booking",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Booking_PortDestinyId",
                table: "Booking",
                column: "PortDestinyId");

            migrationBuilder.CreateIndex(
                name: "IX_Booking_PortOriginId",
                table: "Booking",
                column: "PortOriginId");
